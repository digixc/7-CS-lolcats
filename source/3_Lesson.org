...
:END:
- To animation only explains the two of the definitions of *variables*, *functions*, and *loops*.
** Badge It - Gold
:PROPERTIES:
:HTML_CONTAINER_CLASS: gold
:END:
- In addition to above Silver, your animation explains all the three concepts that shows good understanding.

** Badge It - Platinum
:PROPERTIES:
:HTML_CONTAINER_CLASS: platinum
:END:
- In addition to the above, your animation explains all three concepts in *good English* AND with *relevant examples* clearly showing excellent understanding. 
