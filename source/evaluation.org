...
* My Lol Cat - End of Unit Self Evaluation
:PROPERTIES:
:HTML_CONTAINER_CLASS: activity
:END:
...
:HTML_CONTAINER_CLASS: try
:END:
- Open new Word document and give your work a title "My Lol cat Self Evaluation"
- Take a screenshot of your progress ladder graph and the graph below and add them to your new word document
- Underneath the graphs, make a a sub-heading for each of the strand for this unit. You can find all the avaible strands for this unit in your bournetolearn, My Lol Cat, similar to the example shown below.
[[./img/unitLearningStrands.png]]

  - Under each heading/learning strand, evaluate the following:
    - What went well (WWW)
    - Even better if you ... (EBI)
    - Reflect your work habit - focus, follow notes and instructions, ask questions when stuck etc
* Assessment
:PROPERTIES:
:HTML_CONTAINER_CLASS: activity
:END:
